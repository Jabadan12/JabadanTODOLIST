      ...
      <div className="m-5 w-full max-w-md bg-white p-6 rounded-lg shadow-lg">
        ...
        <div className="flex items-center space-x-3 mb-100">
          <input
            ...
            className="border border-blue-100 p-2 rounded-md w-full"
          />
          <button
            onClick={addTask}
          ...
          {tasks.map((task) => (
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                />
                <span
                  className={`flex-grow ${task.completed ? "line-through text-yellow-500" : "text-red-800"}`}
                >
                  {task.text}
                </span>
              </div>
              ...
              <button
                ...
                className="ml-4 bg-blue-500 text-white p-1 rounded-md hover:bg-red-400 transition"
